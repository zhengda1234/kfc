...
<div class="header">
    <div class="container">
        <div class="header_top">
            <ul class="phone">
                <li class="phone_left"><i class="mobile"> </i><span>0791-88888888</span></li>
                <li class="phone_right">商品免费送达 ¥100</li>
                ...
                <nav class="navbar navbar-default menu" role="navigation">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse"
                            ...
                            <div
                                    style="margin-top: -6%; margin-right: -3%; float: right; color: #FFFFFF; font-family: 宋体;">
                            ...
                            <div style="margin-top: -13%; margin-right: 24%; float: right;">
                                <ul>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="login_top"><i class="sign"> </i><span
                                                    style="color: #00FF00; font-size: 12; font-family: 宋体;">未登录</span>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </ul>
        ...
        <div class="row content">
            <div class="col-md-3 content_top">
                ...
                <ul class="product_reviews">
                    ...
                    <img
                            src="http://img5.imgtn.bdimg.com/it/u=2836686556,3695534867&fm=27&gp=0.jpg"
            ...
            <div class="col-md-9">
             ...
             <li class="grid1"><a href="single.jsp"><img src="${r.images_path}"  class="img-responsive" alt=""/>
                ...
                <ul class="feature">
                    <h3>
                        <i class="arrow"> </i><span>搜索结果</span>
                    </h3>
                </ul>
