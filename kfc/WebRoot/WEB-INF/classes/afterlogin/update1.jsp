            ...
            <form role="form" action="update.action" method="post">
                <div>
                    <%--  <input type="text" name="user.id"
                        value="${user.id}"><br>
                        <label>姓名</label> <input  type="text" name="user.role"
                         value="${user.role}"><br> --%>
                    <label>姓名</label> <input type="text" readonly="readonly" name="user.userName"
                                             value="${user.userName}">
                    <p class="help-block">用户名不可更改</p>
                    <div style="background-color:red;">${info}</div>
                </div>
                ...
                <div>
                    <label>电话</label> <input type="text" name="user.userTel"
                                             value="${user.userTel}"
                                             placeholder="电话不能为空号">
                </div>
                <div>
                    <label>邮箱</label> <input type="text" name="user.userEmail"
