...
<div class="main">
    <div class="container">
        <div class="Product_top">
            <form onsubmit="return checkuser()" action="submit.action" method="post" name="myform">
                <div class="register-top-grid" align="center">
                    <h3>订单信息</h3>
                    <table align="center" border="10">
                        <tr><span>商品<label>*</label></span>
                        ...
                        <tr>
                            <span>订单总额<label>*</label></span>
                            ${price}
                        </tr>
                        <br>
                        <tr>
                            <span>送货地址<label>*</label></span>
                            <input type="text" name="order.orderAddress" id="address">
                        </tr>
                        <br>
                        <tr>
                            <span>其他要求<label>*</label></span>
                            <input type="text" name="order.otherRequire">
                        </tr>
                        <br>
