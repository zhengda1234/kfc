    ...
    <div class="container">
        <div class="header_top">
            ...
            <ul class="shopping_cart">
                <a href="cart0.jsp">
                    <li class="shop_left"><i class="cart">
                    </i><span>商品${cart }件</span></li>
                </a>
                <a href="#">
                            ...
                            <div style="margin-top: -14%; margin-right: 13%; float: right;">
                                <ul>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="login_top"><i class="sign"> </i><span
                                                    style="color: #00FF00; font-size: 12; font-family: 宋体; margin-right: 120px;">未登录</span>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </ul>
                            ...
                            <ul class="login">
                                <c:choose>
                                    <c:when test="${user!=null}">
                                        ...
                                        <a href="register.jsp">
                                            <li class="login_bottom"><i
                                                    class="register"> </i><span>注册</span></li>
                                        </a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="account.jsp">
                                            <li class="login_top"><i
                                                    class="sign"> </i><span>登录</span></li>
                                        </a>
                                        <a href="register.jsp">
                                            <li class="login_bottom"><i
                                                    class="register"> </i><span>注册</span></li>
            ...
            <div class="search">
                <form action="ss.action" method="post">
                    <input type="text" class="text" name="meal.mealName"
                           ...
                           onblur="if (this.value == '') {this.value = '输入商品详情';}"/>
        ...
        <div class="row content">
            <div class="col-md-3 content_top">
                <div class="category_box" style="height: 600px;">
                    <div class="mulu" style="height: 150px; width: 100%;">
                        <img src="images/mulu.png" height="100%" width="100%" alt=""/>
                    </div>
                    <span id="menu01" onClick="showOrHide(1)"
                          style="background-color: #00B025; color: #FFFFFF;"><p
                    ...
                    <br> <span id="menu02" onClick="showOrHide(2)"
                               style="background-color: #F58316; color: #FFFFFF;"><p
                    ...
                    <br> <span id="menu03" onClick="showOrHide(3)"
                               style="background-color: #0C1A43; color: #FFFFFF;"><p
                    ...
                    <div style="margin-bottom: 0px;">
                        <p style="font-size: 9px; color: #A2A2CE;">
                            <br>注：早餐、夜宵仅限部分肯德基宅急送送餐区域供应。肯德基宅急送实行专属菜单及价格，不同城市的送餐菜单有所不同。不同时段产品品项及价格有所不同
                        </p>
                    </div>
                </div>
                <ul class="product_reviews">
                    <h3>
                        <i class="arrow"> </i><span>商品评论</span>
                    </h3>
                    <li>
                        <ul class="review1">
                ...
                <ul class="product_reviews">
                    <h3>
                        <i class="arrow"> </i><span>支付方式（目前只支持两种）</span>
                    </h3>
            ...
            <div class="col-md-9">
                <ul class="feature">
                    <h3>
                        <i class="arrow"> </i><span>今天的特色商品</span>
                    </h3>
                </ul>
                <ul class="feature_grid">
                    <li class="grid1"><img src="images/breakfast_02_04.png"
                                           class="img-responsive" alt=""/>
                        <!--<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed</p>-->
                        <div class="price">
                            价格: <span class="actual">12元</span>
                        </div>
                        <div class="but1">
                            <a href="#">立即购买</a>
                        </div>
                    </li>
                    <li class="grid1"><img src="images/breakfast_03_04.png"
                                           class="img-responsive" alt=""/>
                        <p></p>
                        <div class="price">
                            价格: <span class="actual">12元</span>
                    ...
                    <li class="grid2"><img src="images/breakfast_03_05.png"
                                           class="img-responsive" alt=""/>
                        <p></p>
                        <div class="price">
                            价格: <span class="actual">12元</span>
                ...
                <ul class="feature">
                    <h3>
                        <i class="arrow"> </i><span>火爆商品</span>
                    </h3>
                </ul>
                <div class="row content_bottom">
                        ...
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_04_04.png" class="img-responsive"
                                         alt=""/>
                    ...
                    <div class="col-md-3">
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_05_06.png" class="img-responsive"
                                         alt=""/>
                                    <div class="content_box-grid">
                                        <!-- <p class="m_1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p> -->
                                        <div class="price">
                    ...
                    <div class="col-md-3">
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_04_01.png" class="img-responsive"
                                         alt=""/>
                                    <div class="content_box-grid">
                                        <!--   <p class="m_1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p> -->
                                        <div class="price">
                    ...
                    <div class="col-md-3">
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_06_04.png" class="img-responsive"
                                         alt=""/>
                                    <div class="content_box-grid">
                                        <!--  <p class="m_1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p> -->
                                        <div class="price">
                ...
                <div class="row content_bottom1">
                    <div class="col-md-3">
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_03_04.png" class="img-responsive"
                                         alt=""/>
                                    <div class="content_box-grid">
                                        <!-- 	  <p class="m_1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p> -->
                                        <div class="price">
                    ...
                    <div class="col-md-3">
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_05_01.png" class="img-responsive"
                                         alt=""/>
                                    <div class="content_box-grid">
                                        <!--   <p class="m_1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p> -->
                                        <div class="price">
                    ...
                    <div class="col-md-3">
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_04_02.png" class="img-responsive"
                                         alt=""/>
                                    <div class="content_box-grid">
                                        <!--  <p class="m_1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p> -->
                                        <div class="price">
                    ...
                    <div class="col-md-3">
                        <div class="content_box">
                            <a href="single.jsp">
                                <div class="view view-fifth">
                                    <img src="images/lunch_06_01.png" class="img-responsive"
                                         alt=""/>
                                    <div class="content_box-grid">
                                        <!-- 				   	   	  <p class="m_1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p> -->
                                        <div class="price">
