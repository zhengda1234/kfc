                                                    ...
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            ...
                                                            <button type="button" class="btn btn-default"
                                                                    ...
                                                                    onclick="send(${order1.id})">配送
                                                            </button>
                                                            <a data-toggle="collapse" data-parent="#accordion"
                                                               href="#collapse${order1.id}"
                                                               class="collapsed ">订单号：${order1.id}，订单总额：${order1.orderTotal
                                                            ...
                                                            <div class="table-responsive">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a
                                                                                href="backOrder!deleteOrder.action?order.id=${order1.id}"
