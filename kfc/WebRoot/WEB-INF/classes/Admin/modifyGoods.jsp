                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="select">
                                                <label> <select name="meal.mealType">
                                                    <option>请选择</option>
                                                    <option value="早餐_主食"
                                                            <c:if test="${meal.mealType=='早餐_主食' }">selected="selected"</c:if>>
                                                        早餐主食
                                                    </option>
                                                    <option value="早餐_辅食"
                                                            <c:if test="${meal.mealType=='早餐_辅食' }">selected="selected"</c:if>>
                                                        早餐辅食
                                                    </option>
                                                    <option value="早餐_饮品"
                                                            <c:if test="${meal.mealType=='早餐_饮品' }">selected="selected"</c:if>>
                                                        早餐饮品
                                                    </option>
                                                    <option value="早餐_套餐"
                                                            <c:if test="${meal.mealType=='早餐_套餐' }">selected="selected"</c:if>>
                                                        早餐套餐
                                                    </option>
                                                    <option value="午餐_主食"
                                                            <c:if test="${meal.mealType=='午餐_主食' }">selected="selected"</c:if>>
                                                        午餐主食
                                                    </option>
                                                    <option value="午餐_辅食"
                                                            <c:if test="${meal.mealType=='午餐_辅食' }">selected="selected"</c:if>>
                                                        午餐辅食
                                                    </option>
                                                    <option value="午餐_饮品"
                                                            <c:if test="${meal.mealType=='午餐_饮品' }">selected="selected"</c:if>>
                                                        午餐饮品
                                                    </option>
                                                    <option value="午餐_套餐"
                                                            <c:if test="${meal.mealType=='午餐_套餐' }">selected="selected"</c:if>>
                                                        午餐套餐
                                                    </option>
                                                    <option value="晚餐_主食"
                                                            <c:if test="${meal.mealType=='晚餐_主食' }">selected="selected"</c:if>>
                                                        晚餐主食
                                                    </option>
                                                    <option value="晚餐_辅食"
                                                            <c:if test="${meal.mealType=='晚餐_辅食' }">selected="selected"</c:if>>
                                                        晚餐辅食
                                                    </option>
                                                    <option value="晚餐_饮品"
                                                            <c:if test="${meal.mealType=='晚餐_饮品' }">selected="selected"</c:if>>
                                                        晚餐饮品
                                                    </option>
                                                    <option value="晚餐_套餐"
                                                            <c:if test="${meal.mealType=='晚餐_套餐' }">selected="selected"</c:if>>
                                                        晚餐套餐
                                                    </option>
                                                </select> </label>
