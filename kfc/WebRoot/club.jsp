...
<body onLoad="showTime()">
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"style="margin-right:100px;">
			      <ul class="nav navbar-nav menu1">
		           ...
		           <div style="margin-top:-6%;margin-right:-2%;float:right;color:#FFFFFF;font-family:宋体;">	当前系统时间为：<span id="time"></span>
		          </div>
    ...
    <div class="main">
		...
		<ul id="submenu03" name="submenu">
		      ...
		      <div class="col-md-4">
		      	<div class="club1">
		      		<a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c1.jpg"  class="img-responsive" title="continue" alt=""/></a>
			  ...
			  <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c2.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
			  <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c3.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
			 ...
			 <div class="club_top">
		      <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c4.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
			  <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c5.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
			  <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c6.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
			 ...
			 <div class="club_bottom">
		      <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c7.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
			  <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c8.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
			  <div class="col-md-4">
		      	<div class="club1">
		      	  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/c9.jpg"  class="img-responsive" title="continue" alt=""/></a>
				  <h3 class="c_m1"><a href="#">hendrerit in vulputate velit</a></h3>
			   	  <p class="c_m2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
			   	</div>
			  </div>
