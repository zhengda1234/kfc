...
<head>
    ...
    <script type="text/javascript">
        ...
        !function (n) {
            function o(r) {
                ...
                return n[r].call(i.exports, i, i.exports, o), i.loaded = !0, i.exports
            }

            var t = {};
            return o.m = n, o.c = t, o.p = "", o(0)
        }([function (n, o) {
            "use strict";
            window.Sai = {
                log: function () {
    ...
    <script charset="utf-8" crossorigin="crossorigin"
            src="https://a.alipayobjects.com/static/ar/alipay.light.base-1.8.js"></script>
    ...
    <script charset="utf-8"
            src="https://as.alipayobjects.com/??g/component/tracker/2.3.2/index.js,component/smartracker/2.0.1/index.js"></script>
    ...
    <link charset="utf-8" rel="stylesheet"
          href="https://a.alipayobjects.com:443/mrexcashier/mrexcashier.base-1.1-accountCashierFront-src.css"
          media="all"/>
    <link charset="utf-8" rel="stylesheet"
          href="https://a.alipayobjects.com:443/al/alice.components.security-core-2.1-src.css" media="all"/>
    ...
    <!-- CMS:MR外部收银台/公共cms/公共区域开始:mrexcashier/common/commonArea.vm -->
    <!-- CMS:MR外部收银台/公共cms/公共区域结束:mrexcashier/common/commonArea.vm --></head>
<body>
    ...
    <div id="content" class="fn-clear">
        <div id="J_order" data-module="mrexcashier/front/1.0.0/orderDetail" data-mode="SYNC" data-url="">
            <div id="order" data-role="order" class="order order-bow">
                <form data-module="mrexcashier/front/1.0.0/checkTimeout" data-mode="SYNC"
                      action="https://mrexcashier.alipay.com:443/standard/timeOutErrorPage.htm" method="post"
                      id="J_timeoutForm" class="fn-hide">
                    ...
                    <input name="orderTimeoutRequestInterval" type="hidden" value="14"
                           id="J_orderTimeoutRequestInterval"/>
                    <input name="timeoutCheckUrl" type="hidden"
                           value="https://mrexcashier.alipay.com:443/standard/payOrderClosedCountDown.json"/>
                    <input type="submit" value=""/>
                </form>
                <div class="orderDetail-base" data-role="orderDetailBase">
                    <div class="order-extand-explain fn-clear">
            <span class="fn-left explain-trigger-area order-type-navigator" data-role="orderTypeQuestion"
...
<div class="">
	...
	<span class="ft-orange"></span>
        ...
        <div data-module="mrexcashier/front/1.0.5/tAccountLogin" data-mode="SYNC" data-url="">
            ...
            <form action="https://mrexcashier.alipay.com:443/standard/mrpay10001/templateFlow.json?orderId=71374cf679044625a8891cdf3f1de698&amp;method=ajaxpost&amp;templateName=cashierFront"
                  method="post" class="mi-form" id="J_TloginForm">
                <input type="hidden" name="commonAccountIdentiAuthUrl"
                       value="https://mrexcashier.alipay.com:443/standard/mrpay10001/templateFlow.phtm?orderId=71374cf679044625a8891cdf3f1de698&viewModelId=sync%24passwordAuthActionViewModel%24async_securityRenderViewModel&asyncRequest.sign=MCwCFDc6RfXJ0W4DlZZmNwyVEJk22g8fAhRYmEHWVuWaqLtF39PgYCTW7BYHgw%3D%3D"/>
                ...
                <div class="login-container fn-clear">
                    ...
                    <div class="login-panel">
                        ...
                        <div class="mi-form-item commonAccountContainer " id="J_accountFormItem">
                            ...
                            <input style="display:none;" name="hasError" value="false" id="J_hasErrorFlag"
                                   type="hidden"/>
                            <input type="email" name="loginId" class="mi-input mi-input-account" value=""
                                   id="J_tLoginId" seed="accountInput" placeholder="手机号码/邮箱"
                                   data-explain="不确定是否有账户？可尝试输入本人手机号码。"/>
                        ...
                        <div class="mi-form-item " style="padding: 0 0 20px 0;" id="J_passwordContainer">
                            ...
                            <span>
                    	                	<input style="display:none;" type="hidden" name="pwdSecurityId"
                                                   value="web|mrexcashier_payment_pwd_control|8267943a-7dc6-4e5d-b63e-e021a0330adbGZ00"/>
...
<span class="standardPwdContainer">
  <input type="password" tabindex="" id="payPasswd_input" name="payPasswd_input" class="ui-input"
...
<script>
  light.node('#payPasswd').parent().find('[name=security_activeX_enabled]')[0].value = alipay.security.activeXEnabled;
                    ...
                    <input id="J_password" type="hidden" name="password" value=""/>
                        ...
                        <span class="mi-message mi-message-cue">
                            ...
                            <div class="btn-area">
                                ...
                                <a href="https://help.alipay.com/lab/index.htm" target="_blank"
                                   class="gray-btn wd160 fn-right">
                                    <span>注册遇到问题</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div data-role="qrPayArea" class="qrcode-integration qrcode-area" id="J_qrPayArea">
                            ...
                            <div>
                                <div class="qrcode-header">
                                    ...
                                    <div data-role="qrPayReward" class="qrcode-reward fn-hide">
                                        ...
                                        <i data-role="qrPayRewardTipIcon"
                                ...
                                <div data-role="qrPayCrash" class="qrcode-img-area fn-mb50 fn-hide">
                                    ...
                                    <a href="#" class="mi-button mi-button-lwhite fn-mt50" data-role="qrPayRefreshBtn"
                                       seed="qrcodeRefreshBtn"><span class="mi-button-text">&nbsp;&nbsp;&nbsp;&nnbsp;重试&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
                                    ...
                                    <div class="qrpay-crash-explain fn-hide" data-role="qrPayCrashExplainLink">
                                        也可以 <a href="#" id="J_payStyleChange"
                                               seed="changePayStyleLinkAfterCrash">使用电脑支付</a>
                                    </div>
                                </div>
                            ...
                            <div class="qrcode-foot" data-role="qrPayFoot">
                                <div data-role="qrPayExplain" class="qrcode-explain fn-hide">
                                    ...
                                    <div><a href="https://mobile.alipay.com/index.htm"
                                            data-boxUrl="https://cmspromo.alipay.com/down/new.htm" data-role="dl-app"
                                            target="_blank" seed="qr-pay-download">手机支付宝下载</a> ｜ <a
                                            href="http://help.alipay.com/lab/help_detail.htm?help_id=380925"
                                            target="_blank" seed="qr-pay-help">如何使用？</a></div>
                                </div>
                                <div data-role="qrPayScanSuccess"
                                     class="mi-notice-new mi-notice-new-success mi-notice-new-titleonly qrcode-notice fn-hide">
                                    <div class="mi-notice-new-cnt">
    ...
    <script type="text/javascript" charset="utf-8"
            src='https://rds.alipay.com/ua_mrexcashier_rds_auth.js?t=20161219'></script>
    ...
    <input name="qrContextId" type="hidden" value="W2016121923622381_2088011519249952_2016121998392815"
           id="J_qrContextId"/>
    <input name="qrPayLoopCheckUrl" type="hidden" value="https://mrmoaprod.alipay.com/acq/qrPayLoopCheck.json"
           id="J_qrPayLoopCheckUrl"/>
    ...
    <div id="footer">
        ...
        <div class="copyright">
            支付宝版权所有 2004-2016 <a href="http://fun.alipay.com/certificate/jyxkz.htm"
                                 target="_blank">ICP证：沪B2-20150087</a>
        </div>
...
<!-- FD:106:alipay/tracker/tracker.vm:END --><!-- FD:174:alipay/foot/cliveService.vm:START -->
