                                    ...
                                    <c:choose>
                                        <c:when test="${user!=null}">
                                            <li class="login_top"><i class="sign"> </i><span
                                                    style="color: #00FF00; font-size: 12px; font-family: 宋体;">您好，${user.userName}</span>
                                            </li>
                                            <a href="loginServlet?method=quit">
                                                <li
                                                        class="login_bottom"><i class="register"> </i><span
                                                        style="color: #00FF00; font-size: 12px; font-family: 宋体;">退出登录</span>
                                                </li>
                                            </a>
                                        </c:when>
                                        <c:otherwise>
            ...
            <div class="search">
                <form action="ss.action" method="post">
                    <input type="text" class="text" name="meal.mealName"
                           ...
                           onblur="if (this.value == '') {this.value = '输入商品详情';}"/> <input
