...
<div class="main">
    <div class="container">
        <div class="Product_top">
            ...
            <ul class="phone">
                <li class="phone_left"><i class="mobile"> </i><span style="color: red;font-size: 40px;">购物车  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付总额:${price }元 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="deleteall.action">删除所有商品</a></span></li>

            </ul>
            <table border="1" width="100%" cellpadding="0" bordercolor="#CB082C" cellspacing="0" align="center"
                   style="color: #932CE5;">
                <tr>
                    <th></th>
                    <th>商品名</th>
            ...
            <ul class="shopping_cart" style="height: 30px;width: 120px;">
                <a href="submit.jsp">
                    <li class="shop_left"><i class="cart"> </i><span>提交订单</span></li>
                </a>
