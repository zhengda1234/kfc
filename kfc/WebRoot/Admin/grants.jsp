...
<head>
    ...
    <script type="text/javascript">
        function deleteById(id) {
            if (confirm("您是否确定要删除？")) {
                location.href = "backModule!deleteModule.action?id=" + id;
            }
        }

        /* function updateById(id){
            location.href="tbUserServlet?method=toUpdate&id="+id;
        } */
    </script>
</head>
<body>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li><a class="active-menu" href="grants.jsp"><i
                        class="fa fa-sitemap"></i> 模块信息管理<span class="fa arrow"></span>
                </a> </li>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <label>所属部门为</label>
                                        <input class="form-control" type="text" placeholder="根据id查询所属部门类别">

                                    </div> -->
                                        <div class="form-group">
                                            <P>
                                                <a href="addGrants.jsp">添加模块</a>
                                        ...
                                        <tr>
                                            <td colspan="8">
                                                <div class="pagelist">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${requestScope.newPage==1}">
                                                            <a href="javascript:volid(0);">上一页</a>
                                                        </c:when>
                                                        <c:when test="${requestScope.newPage!=1}">
                                                            <a href="backModule!toPart.action?newPage=${requestScope.newPage-1}">上一页</a>
                                                        </c:when>
                                                    </c:choose>


                                                    <c:forEach items="${requestScope.pageNumberList}" var="pageNumber">
                                                        <c:choose>
                                                            <c:when test="${requestScope.newPage==pageNumber}">
                                                                <span class="current">${requestScope.newPage}</span>
                                                            </c:when>
                                                            <c:when test="${requestScope.newPage!=pageNumber}">
                                                                <a href="backModule!toPart.action?newPage=${pageNumber}">${pageNumber}</a>
                                                            </c:when>
                                                        </c:choose>
                                                    </c:forEach>
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${requestScope.pageNumber!=1}">
                                                            <a href="backModule!toPart.action?newPage=${requestScope.newPage+1}">下一页</a>
                                                        </c:when>
                                                    </c:choose>
                                        ...
                                        <a  href="#">已有模块 </a>
                                            <ul  class="nav nav-second-level">
                                                <li>商品信息模块
                                                    <ul  class="nav nav-third-level"s>
                                                        <li>
                                                            <a href="#">删除模块</a>
                                                        </li>
                                                        <li>
                                        ...
                                        <label>已有权限为</label>
                                            ...
                                            <div class="checkbox">
                                            <label>
                                                <input type="checkbox" value="">商品信息模块
                                            </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">用户信息模块
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">订单信息模块
                                                </label>
                                            </div>
                                             <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">销售统计模块
                                                </label>
                                            </div>
                                             <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">管理员信息模块
                                                </label>
                                            </div>
                                             <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">模块管理
                                                </label>
                                            </div>
