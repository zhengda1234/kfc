...
public class UserDAO extends BaseHibernateDAO {
	...
	public List findByExample(User instance) {
		try {
			List results = getSession().createCriteria("com.newer.pojo.User").add(Example.create(instance)).list();
			return results;
		} catch (RuntimeException re) {
			throw re;
		}
	...
	public List<User> findByCondition(User user) {
		...
		Query query = getSession().createQuery("from User as u where u.userName like :name");
