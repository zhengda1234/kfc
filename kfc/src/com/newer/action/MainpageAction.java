...
@Results({ @Result(name = "success", location = "/success.jsp"), @Result(name = "failed", location = "/index.jsp"),
		@Result(name = "error", location = "/error.jsp") })
@ExceptionMappings({ @ExceptionMapping(exception = "java.lang.Exception", result = "error") })
public class MainpageAction extends ActionSupport implements RequestAware, SessionAware, ApplicationAware {
