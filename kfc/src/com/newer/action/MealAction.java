...
@Results({ @Result(name = "success", location = "/fruits.jsp"), @Result(name = "xiangxi", location = "/single.jsp"),
		@Result(name = "liulan", location = "/panini.jsp"), @Result(name = "error", location = "/erro.jsp") })
public class MealAction extends ActionSupport implements RequestAware, SessionAware, ApplicationAware {
	...
	public String meal() throws Exception {
		...
		// if(Integer.parseInt(results.get(j).getMealPrice()) >
		// Integer.parseInt(results.get(j+1).getMealPrice()))
		// {
		...
		//
		// //升序排列
		// if(Integer.parseInt(o1.getMealPrice()) >
		// Integer.parseInt(o1.getMealPrice())){
		// return 1;
		// }
		// if(Integer.parseInt(o1.getMealPrice()) ==
		// Integer.parseInt(o1.getMealPrice())){
	...
	// @Action(value = "meal")
	/*
	 * private String findall() throws Exception { List<Meal> result =
	 * dao.findByMealType("帕尼尼"); System.out.println("ddddddddddddd"); return
	 * "success";
	 */
	// }
