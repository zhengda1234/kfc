...
@Results({@Result(name = "success", location = "/panini.jsp"),
        ...
        @Result(name = "success3", location = "/fruits.jsp"), @Result(name = "success4", location = "/cart0.jsp"),
...
public class SearchAction extends ActionSupport implements RequestAware, SessionAware, ApplicationAware {
    ...
    public String buy() throws Exception {
        ...
        /*
         * Meal mm=new
         * Meal(m.getId(),m.getMealName(),m.getMealIntroduce(),m.getMealPrice(),m.
         * getMealType(),m.getMealAmount(),m.getSaleTime(),m.getImages_path());
         */
    ...
    public String submit() throws Exception {
        ...
        if (session.get("user") != null) {
            ...
            /*
             * User user2=new User(); user2.setId(user1.getId());
             */
            order.setUser(user1);
