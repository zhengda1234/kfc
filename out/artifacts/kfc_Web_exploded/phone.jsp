    ...
    <div class="container">
        <div class="header_top">
            <ul class="phone">
                ...
                <li class="phone_right">商品免费送达</li>
                ...
                <nav class="navbar navbar-default menu" role="navigation">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse"
                            ...
                            <div
                                    style="margin-top: -4.5%; margin-right: -10%; float: right; color: #FFFFFF; font-family: 宋体;">
            ...
            <div class="search">
                <form action="ss.action" method="post">
                    <input type="text" class="text" name="meal.mealName"
                           ...
                           onblur="if (this.value == '') {this.value = '输入产品详情';}"/>
...
<DIV style="height: 550px">
    ...
    <div class="containers">
        ...
        <div style="*width: 50%; *margin-top: -150px">
            <div class="text_tip">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点肯德基宅急送就用</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;肯德基超级APP
            </div>
            <div class="text_tip2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;全新肯德基官方APP
                开启自在模式！
            </div>
            <div
                    style="float: left; width: 411px; margin-left: 22px; margin-top: 9px;">
					<span> <img src="images/gou.png" alt=""/> <span
                            style="margin-top: 5px;">外送点餐</span>
					</span> <span> <img src="images/gou.png" alt=""/><span
                    style="margin-top: 5px;">会员积分</span>
					</span> <span> <img src="images/gou.png" alt=""/> <span
                    style="margin-top: 5px;">更多优惠券</span>
					</span>
            </div>
