                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="backAdmin!modifySuccess.action"
                                        ...
                                        <div class="form-group">
                                            <label>所属部门</label> <select class="form-control" name="user.role.roleId"
                                                                        disabled="disabled">
                                            <option value="2"
                                                    <c:if test="${user.role.roleId=='2' }">selected="selected" </c:if>>
                                                系统维护部门
                                            </option>
                                            <option value="3"
                                                    <c:if test="${user.role.roleId=='3' }">selected="selected" </c:if>>
                                                配送部门
                                            </option>
                                            <option value="4"
                                                    <c:if test="${user.role.roleId=='4' }">selected="selected" </c:if>>
                                                销售部门
                                            </option>
                                        </select>
                                        </div>
