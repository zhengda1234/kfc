    ...
    <div class="container">
        <div class="header_top">
            ...
            <ul class="shopping_cart">
                <a href="#">
                    <li class="shop_left"><i class="cart"> </i><span>Shop</span></li>
                </a>
                <a href="#">
                ...
                <div class="col-md-9">
                    ...
                    <div class="account_grid">
                        <div class="col-md-6 login-left">
                            <h3>新用户</h3>
                            <p>通过创建一个帐户与我们的商店，你将能够更快地通过结帐过程，存储多个送货地址，查看和跟踪您的订单在您的帐户和更多。</p>
                        ...
                        <div class="col-md-6 login-right">
                            <h3>用户登录</h3>
                            <p>如果你已经有账户了，你请登录</p>
                            <form onsubmit="return checkname()" action="loginServlet?method=login" method="post"
                                  name="myform">
                                <div>
                                ...
                                <div style="margin-left:0px;margin-top:12px;float:left;">验证码
                                    <input id="yan" type="text" name="code"
                                           style="width:180px; height:20px; border:solid 1px #000000; color:#666666;margin-top:12px;">
                                    <div style="height:22px;float:right; width:100px; margin-left:2px;"/>
                                    <br>
                                    <img src="validate.jpg" alt="点击切换图片" title="点击切换图片"
