            ...
            <div class="search">
                <form action="ss.action" method="post">
                    <input type="text" class="text" name="meal.mealName" placeholder="请输入你想搜索的内容"
                           onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '输入商品详情';}"/>
            ...
            <div class="row content">
                    ...
                    <ul class="product_reviews">
                        ...
                        <li>
                            <ul class="review1">
                                ...
                                <li class="review1_desc"><h3><a href="#">美味中的极品，赶快来一份吧！</a></h3>
                ...
                <div class="col-md-9">
                    ...
                    <div class="product-filter">
                        <div class="sort"><b>分类查看:</b>
                            <form action="meal1.action" method="post">
                                <select name="select">

                                    <option value="low" selected="selected">价格 (从低到高)</option>
                                    <option value="high">价格(从高到低)</option>
                                </select>
                        ...
                        <div class="product-compare"><a href="#" id="compare-total">产品比较</a></div>
                        <div class="clearfix"></div>
                    </div>
